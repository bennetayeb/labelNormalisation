...
class HTSLabelNormalisation(LabelNormalisation):
    ...
    def compute_coarse_coding_features(self, num_states):
        ...
        cc_features[0, :] = norm.ppf(x1, mu1, sigma)
        cc_features[1, :] = norm.ppf(x2, mu2, sigma)
        cc_features[2, :] = norm.ppf(x3, mu3, sigma)
    ...
    def extract_coarse_coding_features_absolute(self, phone_duration):
        ...
        y1 = norm.ppf(x1, mu1, sigma1)
        y2 = norm.ppf(x2, mu2, sigma2)
        y3 = norm.ppf(x3, mu3, sigma3)
